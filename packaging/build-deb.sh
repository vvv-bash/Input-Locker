...
# Copy launch scripts from source (keeps latest logic)
if [ -f "$SOURCE_DIR/input-locker.sh" ]; then
    cp "$SOURCE_DIR/input-locker.sh" "$PKG_DIR/opt/input-locker/"
    chmod +x "$PKG_DIR/opt/input-locker/input-locker.sh"
fi

if [ -f "$SOURCE_DIR/input-locker-electron.sh" ]; then
    cp "$SOURCE_DIR/input-locker-electron.sh" "$PKG_DIR/opt/input-locker/"
    chmod +x "$PKG_DIR/opt/input-locker/input-locker-electron.sh"
fi
