...
class SelectiveKeyboardBlocker:
    ...
    def __init__(self, device: InputDevice, allowed_keys: set, hotkey_callback=None):
        """
        ...
        # Añadir las teclas del patrón a las teclas permitidas
        pattern_keys = {
            ecodes.KEY_UP,
            ecodes.KEY_DOWN,
            ecodes.KEY_LEFT,
        ...
        logger.info(f"✓ Teclas del patrón añadidas a las permitidas")
